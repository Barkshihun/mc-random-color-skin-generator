    ...
    <div className="grid grid-cols-colorForm items-center pl-2 h-1/5 relative">
      {rgbaInfo.color === "alpha" && (
        <div className="absolute sm:left-[-6px] left-[-4px] group">
          ...
          <p className="shadow-lg absolute left-[-26px] top-[21px] text-sm p-[10px] text-white text-center hidden w-30 break-keep bg-slate-500 rounded-lg z-10 group-hover:block after:absolute after:border-solid after:border-[7px] after:ml-[-7px] after:bottom-full after:left-[31px] after:border-t-transparent after:border-r-transparent after:border-l-transparent after:border-b-slate-500">
            Alpha값은 오버레이 부분에만 적용됩니다.
          </p>
        </div>
      )}
